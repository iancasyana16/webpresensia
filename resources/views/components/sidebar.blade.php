<div class="container max-w-4xl p-3 bg-red-800 min-h-full">
    ...
    <ul class="text-lg font-semibold">
        ...
        <li
            class="p-2 text-white hover:bg-red-900 rounded transition-colors cursor-pointer mb-2 {{ request()->routeIs('dashboard-admin-angkatan') ? 'bg-red-900' : 'hover:bg-red-900' }}">
            <a href="{{ Route('dashboard-admin-angkatan') }}" class="flex gap-2 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="size-6" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                    class="size-6">
        ...
        <li
            class="p-2 text-white hover:bg-red-900 rounded transition-colors cursor-pointer mb-2 {{ request()->routeIs('dashboard-admin-kelas') ? 'bg-red-900' : 'hover:bg-red-900' }}">
            <a href="{{ route('dashboard-admin-semester') }}" class="flex gap-2 items-center">
